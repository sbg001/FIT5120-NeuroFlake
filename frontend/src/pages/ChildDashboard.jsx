...
function ChildDashboard() {
  ...
  return (
    <section className="page-section child-dashboard child-dashboard--simple">
      <div className="child-dashboard__top-grid">
        <div className="child-dashboard__intro">
          <p className="eyebrow">Today</p>
          <h2>Hi {displayName}. Let&apos;s do one clear task.</h2>
          <p className="page-text">
            Follow the path, focus on one step, then see your win.
          </p>
        </div>

        <Card className="child-dashboard__journey-card nf-enter-card nf-enter-card--1" variant="soft">
      ...
      <Card className="child-dashboard__focus-card nf-enter-card nf-enter-card--2" variant="glow">
        <div className="child-dashboard__focus-grid">
          <div className="child-dashboard__focus-copy">
            <div>
            ...
            {featuredTask ? (
              <>
                ...
                <div className="child-dashboard__mission-actions child-dashboard__mission-actions--single">
          ...
          <div className="child-dashboard__focus-side">
            <div className="child-dashboard__mascot child-dashboard__mascot--large">
              {currentCharacter}
            </div>
            <div className="child-dashboard__focus-hint">
              <strong>Focus helps.</strong>
              <span>Open the task, then choose Focus if you want extra calm.</span>
            </div>
            <Badge tone="mint">
              {readyTasks.length > 0 ? `${readyTasks.length} ready` : "Clear board"}
            </Badge>
      ...
      <div className="child-dashboard__quick-stats nf-enter-card nf-enter-card--3">
        <div className="child-dashboard__quick-stat">
      ...
      <div className="child-dashboard__bottom-grid child-dashboard__bottom-grid--simple">
        ...
        <Card className="child-dashboard__reward-card nf-enter-card nf-enter-card--5" variant="soft">
          <div className="child-dashboard__section-row">
            <div>
          ...
          <p className="page-text">
            Finished tasks turn into points and rewards.
          </p>
      ...
      <Card className="child-dashboard__style-card nf-enter-card nf-enter-card--6" variant="soft">
          <div className="child-dashboard__section-row">
            <div>
              <p className="eyebrow">My style</p>
              <h3>Pick how your board feels</h3>
            </div>
          ...
          <div className="child-dashboard__style-form">
            ...
            <Button onClick={handleSavePreferences}>Save My Style</Button>
          </div>
      </Card>
    </section>
  );
